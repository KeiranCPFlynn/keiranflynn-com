            ...
            <div className="max-w-3xl mx-auto px-6 sm:px-8 pt-36 sm:pt-44 pb-24">
                    ...
                    return (
                        <div className="mt-16">
                            <div className="flex items-center justify-between mb-8">
                                ...
                                <Link
                                    href="/blog"
                                    className="text-[12px] text-white/40 hover:text-accent transition-colors"
                                >
                                    All archive posts
                                </Link>
                            </div>
                ...
                <div className="mt-20 glass-card p-8 text-center">
                    ...
                    <p className="text-white/70 mb-6 text-[15px]">
                        This article is part of the older conversation and communication archive. The dedicated conversation page remains available.
                    </p>
                    <Link href="/conversation" className="btn-primary inline-flex">
