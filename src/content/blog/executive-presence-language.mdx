...
> **Executive presence is learnable, not innate.** It's a set of linguistic habits — declarative openings, specific framing of uncertainty, comfortable silence, controlled register — that signal authority, clarity, and confidence. These patterns are learnable, especially with deliberate practice in high-stakes situations.
...
It's learnable. Presence is a set of habits — declarative openings, specific framing of uncertainty, comfortable silence, controlled register — that can be developed through deliberate practice. Leaders with "natural" authority almost universally built it through repeated high-stakes experience.

**What's the quickest language change to improve presence?**

Start with your openings. Replace caveats ("I might be wrong, but...") with declarative statements ("The situation is X. Here's how we're responding."). This single shift signals that you've done the thinking and you're sharing a conclusion, not asking permission to have an opinion.

**Why is presence harder for non-native speakers?**

Cognitive load. Operating in a second language while trying to project confidence requires significant mental bandwidth, which can make it harder to maintain pace, stillness, and precise framing. Preparation — especially of opening lines and key statements — reduces that load at critical moments.

**What is controlled register and why does it matter?**

Controlled register is the ability to shift between formal and conversational tones without losing credibility. A leader who can be precise in a board presentation and human in a team meeting — sounding equally natural in both — has a significant communication advantage. It's a mark of high-level language proficiency.
