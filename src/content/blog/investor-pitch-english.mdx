...
**How far in advance should I prepare for an investor call?**

Start at least a week out for your first call. The first two days should be spent structuring your key statements and preparing your numbers. The remaining days are for practice and refinement. With experience, you can prepare in 2–3 days.

**What's the most common mistake non-native founders make on investor calls?**

Over-hedging — using multiple qualifiers ("maybe", "potentially", "could consider") that signal uncertainty about your own business. Investors hear doubt, not caution.

**Should I script the entire call?**

No. Scripting leads to rigid, unnatural delivery and leaves you vulnerable when questions deviate. Instead, prepare your 5–7 key statements and practise delivering them in multiple formats (full pitch, two sentences, one sentence). Script only your opening and closing.

**What if I don't understand an investor's question?**

Don't guess. Use a recovery phrase: "I want to make sure I answer this precisely — could you rephrase that?" or "Let me repeat my understanding back to you..." This shows careful thinking, not weakness.
